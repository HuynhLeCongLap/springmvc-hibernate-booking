    ...
    <div class="page-overlay">
        <div class="container">
            ...
            <div class="auth-container">
                ...
                <p class="auth-subtitle">Tạo tài khoản để đặt phòng sinh nhật tại rạp phim</p>
                ...
                <form action="${pageContext.request.contextPath}/register" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullName" name="fullName" class="form-control" value="${fullName}" placeholder="Nhập họ và tên đầy đủ của bạn" required />
                    </div>
                    
                    <div class="form-group">
                        <label for="numberPhone" class="form-label">Số điện thoại</label>
                        <input type="text" id="numberPhone" name="numberPhone" class="form-control" value="${numberPhone}" placeholder="Nhập số điện thoại của bạn" required />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-requirements">
                            <p>Mật khẩu cần đáp ứng các yêu cầu sau:</p>
                            <ul>
                                <li>Ít nhất 8 ký tự</li>
                                <li>Có ít nhất 1 chữ hoa và 1 chữ thường</li>
                    ...
                    <div class="tos-agreement">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="termsAgree">
                                Tôi đồng ý với <a href="#">Điều khoản dịch vụ</a> và <a href="#">Chính sách quyền riêng tư</a>
                            </label>
                        </div>
                    </div>
                    
                    <button type="submit" class="auth-btn mt-4">Đăng ký</button>
                </form>
